...
variable "git_commit_message" {
  ...
  default     = "[skip ci] Migrating local Workspaces from terra-migrate to HCP Terraform"
}
...
EOT
  default = {
    "example/compute" = {
      ...
      working_directory = "/home/trex29/terraform/terra-migrate/example/compute"
      workspace_map = {
        default = {
    ...
    "example/storage" = {
      ...
      working_directory = "/home/trex29/terraform/terra-migrate/example/storage"
      workspace_map = {
        default = {
        ...
        testing = {
          tfc_workspace_name = "example_storage_testing"
          variables_map = {
            string_count = {
              description = "Number of strings to create"
              hcl         = false
